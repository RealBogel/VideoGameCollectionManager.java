    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        while (!option.equalsIgnoreCase("quit")) {
            ...
            if (option.equalsIgnoreCase("add")) {
                ...
                VideoGame game = VideoGame.parse(console);
                collectionManager.add(game);
                System.out.println("Game added.");
                System.out.println();
            } else if (option.equalsIgnoreCase("contains")) {
                // TODO: Print the result of your collection manager's 
                // contains method and pass in the result of the Item's parse() metho
                System.out.println("Enter platform to filter by:");
                VideoGame game = VideoGame.parse(console);
                boolean found = collectionManager.contains(game);
                System.out.println("Contains game? " + found);
                System.out.println();
                ...
                String platform = console.nextLine();
                List<VideoGame> filteredGames = collectionManager.filter(platform);
                System.out.println("Filtered games:");
                for (VideoGame game : filteredGames) {
